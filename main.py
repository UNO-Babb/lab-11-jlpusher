...
def shopper(env, id):
    arrive = env.now
    items = random.randint(3, 50) #range of number of items, what if this is different?
...
def checker(env):
    ...
    while True:
        ...
        customer = waitingShoppers.pop(0) #takes an item from the front of the queue or list
        items = customer[1]
...
def main():
    numberCheckers = 6 #changing the number of checkers will impact times
